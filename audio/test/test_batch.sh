...
# /home/ipaulo/recocon/code/recocon.py \
#   -d /tmp/batch4.wav_chunks \
#   -fr 16000 \
...
#   /home/ipaulo/recocon/batches/batch4x.wav

# create `logs` directory in the batches directory
mkdir -p $DIRECTORY/logs

#for b in batch0x.wav ; do
for b in $(ls $DIRECTORY | grep wav$) ; do
		echo $b
		for program in pocketsphinx_batch; do
				echo $program
